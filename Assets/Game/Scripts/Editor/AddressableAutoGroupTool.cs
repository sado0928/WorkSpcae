...
{
    public class AddressableAutoGroupTool
    {
        ...
        public static void AutoGroup()
        {
            ...
            {
                ProcessDirectoryRecursively(new DirectoryInfo(ResBundlePath), settings, ResBundlePath,
                    HotUpdateConsts.GroupPrefixBundle);
            }
            else
            {
            ...
            {
                ProcessDirectoryRecursively(new DirectoryInfo(ResBuildInPath), settings, ResBuildInPath,
                    HotUpdateConsts.GroupPrefixBuildIn);
            }
            else
            {
        ...
        private static void ProcessDirectoryRecursively(DirectoryInfo dirInfo, AddressableAssetSettings settings,
            string rootPath, string groupPrefix)
        {
            ...
            if (hasAssets)
            {
                ...
                AddressableAssetGroup group =
                    FindOrCreateGroup(settings, groupName, "Remote.BuildPath", "Remote.LoadPath");
        ...
        private static AddressableAssetGroup FindOrCreateGroup(AddressableAssetSettings settings, string groupName,
            string buildPathVar, string loadPathVar)
        {    
